...
if(!class_exists('Cpotheme_Widget_Subscribers')){
	class Cpotheme_Widget_Subscribers extends WP_Widget{
		
		function Cpotheme_Widget_Subscribers(){
			$widget_ops = array('classname' => 'cpotheme_subscriber_count', 'description' => __('Displays the subscriber count of your social networks.', 'cpocore'));
			$this->WP_Widget('cpotheme-subscriber-count', __('CPO - Subscriber Count', 'cpocore'), $widget_ops);
			$this->alt_option_name = 'cpotheme_subscriber_count';
		}
	...
	register_widget('Cpotheme_Widget_Subscribers');
}