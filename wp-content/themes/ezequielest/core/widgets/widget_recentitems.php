...
if(!class_exists('Cpotheme_Widget_RecentItems')){
	class Cpotheme_Widget_RecentItems extends WP_Widget{
		
		function Cpotheme_Widget_RecentItems(){
			$widget_ops = array('classname' => 'cpotheme_recent_items', 'description' => __('Displays the most recent items of your choice.', 'cpocore'));
			$this->WP_Widget('cpotheme-recent-posts', __('CPO - Recent Items', 'cpocore'), $widget_ops);
			$this->alt_option_name = 'cpotheme_recent_items';
		...
		function widget($args, $instance){
			$cache = wp_cache_get('cpotheme_recent_items', 'widget');
			...
			wp_cache_add('cpotheme_recent_items', $cache, 'widget');
		}
		...
		function flush_widget_cache(){
			wp_cache_delete('cpotheme_recent_items', 'widget');
		}
	...
	register_widget('Cpotheme_Widget_RecentItems');
}