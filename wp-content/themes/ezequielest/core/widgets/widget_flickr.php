...
if(!class_exists('Cpotheme_Widget_Flickr')){
	class Cpotheme_Widget_Flickr extends WP_Widget {
		...
		function form($instance) {
			...
			<p>
				<label for="<?php echo $this->get_field_id('user_id'); ?>"><?php _e('User ID', 'cpocore'); ?></label>
			...
			<p>
				<label for="<?php echo $this->get_field_id('number'); ?>"><?php _e('Number of Photos', 'cpocore'); ?></label><br/>
