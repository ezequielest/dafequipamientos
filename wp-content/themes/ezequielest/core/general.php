	...
	function cpotheme_fonts($font_name){
		if(is_array($font_name)){
			foreach($font_name as $current_font)
				echo '<link href="http://fonts.googleapis.com/css?family='.$current_font.'" rel="stylesheet" type="text/css">';
		}else{
...
if(!function_exists('cpotheme_postpage_tags')){
	function cpotheme_postpage_tags($display = false, $before = '<div class="post-tags">', $separator = ', ', $after = '</div>'){
