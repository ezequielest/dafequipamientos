...
//Create navigation menu for settings page
if(!function_exists('cpotheme_custom_wpml_nav')){
...
if(!function_exists('cpotheme_custom_wpml_active')){	
...
if(!function_exists('cpotheme_custom_wpml_languages')){
...
if(!function_exists('cpotheme_custom_wpml_default_language')){
...
if(!function_exists('cpotheme_wpml_settings')){
...
if(!function_exists('cpotheme_custom_wpml_option_suffix')){
...
if(!function_exists('cpotheme_custom_wpml_option_url')){
